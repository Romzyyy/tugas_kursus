...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid w-50">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="../siswa/data.php">Siswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="container-fluid w-75 position-relative">
            ...
            include "config.php";
            $no = 1;
            $data = mysqli_query($connect, "select * from matapelajaran")or die (mysqli_error($connect));
...
include "config.php";
if(isset($_GET['kode'])){
mysqli_query($connect, "delete from matapelajaran where id='$_GET[kode]'");
